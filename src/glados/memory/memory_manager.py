...
class MemoryManager:
    """
    Manages all memory operations for GLaDOS including episodic, semantic,
    ...
    def __init__(
        ...
        collection_name: str = "glados_memory"
    ):
        """
        ...
        # Initialize embedding model (CPU only for GLaDOS constraints)
