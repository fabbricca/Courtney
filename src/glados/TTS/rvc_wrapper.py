...
class RVCWrappedSynthesizer:
    ...
    Example:
        ...
        from glados.TTS.rvc_wrapper import RVCWrappedSynthesizer
        
        # Create base TTS
        base_tts = get_speech_synthesizer("glados")  # or kokoro voice
...
def get_rvc_synthesizer(
    ...
    **rvc_kwargs,
    ...
    Args:
        base_voice: Base TTS voice ("glados" or a Kokoro voice name)
