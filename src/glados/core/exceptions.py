"""
Domain-specific exception hierarchy for GLaDOS.

All custom exceptions inherit from GladosException for consistent error handling.
"""
...
class GladosException(Exception):
    """
    Base exception for all GLaDOS errors.
...
class ComponentException(GladosException):
...
class AudioException(GladosException):
...
class LLMException(GladosException):
...
class MemoryException(GladosException):
...
class NetworkException(GladosException):
...
class ConfigurationException(GladosException):
